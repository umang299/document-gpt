"""
ChromaDB Client - A module for interacting with ChromaDB for collection management and data upload.

This module provides a client class for interacting with ChromaDB, allowing the creation, querying, and deletion of collections.
...
Args:
    ...
    required_ext (list, optional): A list of required file extensions (default is ['.pdf']).
    num_files_limit (int, optional): The maximum number of files to load (default is 2).
    chunk_size (int, optional): The chunk size for text splitting (default is 512).
    chunk_overlap (int, optional): The chunk overlap for text splitting (default is 25).
    host (str, optional): The hostname or IP address of the ChromaDB server (default is 'localhost').
    port (int, optional): The port number for the ChromaDB server (default is 8000).
...
Attributes:
    ...
    client (chromadb.HttpClient): An instance of the ChromaDB HTTP client for communication with ChromaDB.

Methods:
    get_collection(collection_name): Get an existing collection by name.
    create_collection(collection_name): Create a new collection or get an existing one by name.
    load_data(file_path): Load data from a file into ChromaDB.
    get_info(collection_name, n=10): Get information about a collection, including the count of items and a preview of the first 'n' items.
...
class ChromaDBClient:
    """
    A client class for interacting with ChromaDB, responsible for creating, querying, and deleting collections.
    ...
    def __init__(self, openai_api_key: str = None,
        ...
        self.num_files_limit = 2 if num_files_limit is None else num_files_limit 
    ...
    def __embedding_model(self):
        ...
        Returns:
            embedding_functions.OpenAIEmbeddingFunction: An instance of the OpenAI text embedding model.
        """
    ...
    def create_collection(self, collection_name):
        ...
        Returns:
            chromadb.Collection: An instance of the created or retrieved collection.
        """
    ...
    def get_info(self, collection_name, n=10):
        """
        Get information about a collection, including the count of items and a preview of the first 'n' items.
        ...
        Returns:
            dict: A dictionary containing collection information, including 'count' and 'items'.
        """
